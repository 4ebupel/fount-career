...
const image = require('@/assets/goalCreationTutorialStepTwo.png')
...
export default function StepTwo({ theme, goal, setGoal }: Props) {
        ...
        <View style={styles.container}>
            <View style={styles.headingContainer}>
                ...
                <Text style={styles.description}>
                    Can you measure and track your progress?
                </Text>
            </View>
